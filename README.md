...
Offline-Scoreboards für Pool (8/9/10-Ball) und 14.1 endlos — reine HTML-Dateien,
kein Server, keine Installation. Der Spielstand wird lokal im Browser
...
Über das 🏠-Symbol oben links geht es zurück zur Startseite.
